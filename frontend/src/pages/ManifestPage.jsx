...
const ORIGINAL = [
  ...
  "En tekst på en app kunne nok vært mer formell, men det ville tatt bort poenget mitt med EKKO. For som jeg hevder: «Din stemme».",
];
...
const AI_EDITED = [
  ...
  { block: "Det viktigste med Ekko er ikke at det er et verktøy for deg som bare vil skrive en bok. Det er et verktøy for deg som står fast. For deg som trenger nye vinklinger, uten å miste din egen fortellerstemme." },
  "En tekst i en app kunne vært mer formell. Men det ville fjernet selve poenget med Ekko. For som jeg hevder: din stemme.",
...
const NOTES = [
  { label: "Stavefeil bevart", detail: "«viktigst av alt» → renset til «viktigste med Ekko». Særegenhet borte." },
      ...
      <section className="hairline-t">
        <div className="max-w-[1500px] mx-auto px-6 md:px-10 py-16 text-center">
          ...
          <h2 className="font-serif-display text-4xl md:text-5xl font-light mt-3 max-w-[26ch] mx-auto" style={{ color: "var(--ink)" }}>
            Ekko sender deg tilbake til <em className="italic" style={{ color: "var(--moss)" }}>deg selv</em>.
          </h2>
