...
const ORIGINAL = [
  ...
  "I tillegg mister jeg oversikten over karakterbeskrivelser, profiler, indre og ytre kamp, kapitler og sammenheng. Dette er noe av det viktigste verktøyet for meg som Bragarmål hjelper meg med.",
